...
namespace GameWasm.Webassembly.Test
{
    class Br : Test
    {
        public Br(string path) : base(path)
        {
        ...
        public override void test()
        {
            ...
            assert(test.Call("nested-block-value"), (UInt32) 9);
            assert(test.Call("nested-br-value"), (UInt32) 9);
            assert(test.Call("nested-br_if-value"), (UInt32) 9);
            assert(test.Call("nested-br_if-value-cond"), (UInt32) 9);
            assert(test.Call("nested-br_table-value"), (UInt32) 9);
            assert(test.Call("nested-br_table-value-index"), (UInt32) 9);            
        }
    }
}
